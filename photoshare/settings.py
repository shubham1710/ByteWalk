...
SECRET_KEY = 'r84=fd6s1hc8^44!31sm5q6rpmo^b-c1d*sm-&@b^gp^z6ww=%'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'shubhamstudent5@gmail.com'
EMAIL_HOST_PASSWORD = 'ardazpkbdapmeclj'

DEFAULT_FILE_STORAGE = 'django_gcloud_storage.DjangoGCloudStorage'

GCS_PROJECT = "ByteWalk"
GCS_BUCKET = "bytewalk"
